...
connection.on(
  ...
  function (roomId, message, roomName, userId, userName) {
...
connection.on(
  ...
  function (deleted, selected, roomName, userId, userName) {
...
connection.on(
  ...
  function (senderId, message, senderName, receiverId, chatId, receiverName) {
